...
FROM
    ...
    WHERE
        icd11_code IN ("MG3Z","MD30","MD11.5","MD12","MD81.4","MD50.1","MB4D","MG26","MB48.0","MG45","EC90.0","MG22")) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ("MG3Z","MD30","MD11.5","MD12","MD81.4","MD50.1","MB4D","MG26","MB48.0","MG45","EC90.0","MG22")
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, "MG3Z","MD30","MD11.5","MD12","MD81.4","MD50.1","MB4D","MG26","MB48.0","MG45","EC90.0","MG22")
