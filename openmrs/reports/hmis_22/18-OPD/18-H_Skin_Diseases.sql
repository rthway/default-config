...
FROM
    ...
    WHERE
        icd11_code IN ('ED80','1A95','ED60.1','EB05','EA8Z','ED70','1B70','1GOO','ED63.0','EC23.2','1F00.0','1E91.Z','EB10','1B72','1B75.0','1B75.3','1B75.2','EA60','1G04','1A61.3','EA90','BD90.0','NE4Z')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('ED80','1A95','ED60.1','EB05','EA8Z','ED70','1B70','1GOO','ED63.0','EC23.2','1F00.0','1E91.Z','EB10','1B72','1B75.0','1B75.3','1B75.2','EA60','1G04','1A61.3','EA90','BD90.0','NE4Z')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'ED80','1A95','ED60.1','EB05','EA8Z','ED70','1B70','1GOO','ED63.0','EC23.2','1F00.0','1E91.Z','EB10','1B72','1B75.0','1B75.3','1B75.2','EA60','1G04','1A61.3','EA90','BD90.0','NE4Z')
