...
FROM
    ...
    WHERE
        icd11_code IN ('AA90', 'AA91', 'CAOA','CA03', 'CA02','ND71','ND72.1','ND72.2','AA42','CA0J','CAOD','CA09.0','AA3Z','CA05.0','1B75.2','CA0Y')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('AA90', 'AA91', 'CAOA','CA03', 'CA02','ND71','ND72.1','ND72.2','AA42','CA0J','CAOD','CA09.0','AA3Z','CA05.0','1B75.2','CA0Y')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'AA90', 'AA91', 'CAOA','CA03', 'CA02','ND71','ND72.1','ND72.2','AA42','CA0J','CAOD','CA09.0','AA3Z','CA05.0','1B75.2','CA0Y')
