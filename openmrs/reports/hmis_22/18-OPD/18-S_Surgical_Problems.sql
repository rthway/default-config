...
FROM
    ...
    WHERE
        icd11_code IN ("DA41.2","DB50.0","DB50.1","DB31.0","GB70.0","MF30","GB21","GB23.5","ME61","EK70.0","EG63.0","DB10","DC12","DC11","DZD5","GB00","GB05.2","DB60","GB02.1","GA90")) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ("DA41.2","DB50.0","DB50.1","DB31.0","GB70.0","MF30","GB21","GB23.5","ME61","EK70.0","EG63.0","DB10","DC12","DC11","DZD5","GB00","GB05.2","DB60","GB02.1","GA90")
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, "DA41.2","DB50.0","DB50.1","DB31.0","GB70.0","MF30","GB21","GB23.5","ME61","EK70.0","EG63.0","DB10","DC12","DC11","DZD5","GB00","GB05.2","DB60","GB02.1","GA90")
