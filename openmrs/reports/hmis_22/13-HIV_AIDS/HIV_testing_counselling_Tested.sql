...
"Total" AS 'HTC Programme-total',	
        ...
        SUM(entries.`Age < 15 years`) AS 'Age < 15 years',		        
        SUM(entries.`Age 14-49 years`) AS 'Age 14-49 years',		        
        SUM(entries.`Age >49 years`) AS 'Age >49 years'
