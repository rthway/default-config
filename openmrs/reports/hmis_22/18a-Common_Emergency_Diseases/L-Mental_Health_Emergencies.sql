...
FROM
    ...
    WHERE
        icd11_code IN ('6C40.3','6C40','6B00','6B60','6A7Z','6A23')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('6C40.3','6C40','6B00','6B60','6A7Z','6A23')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, '6C40.3','6C40','6B00','6B60','6A7Z','6A23')
