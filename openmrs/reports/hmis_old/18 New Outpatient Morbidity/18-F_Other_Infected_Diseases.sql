...
FROM
    ...
    WHERE
    icd11_code IN ('CA4Z','CA07.0','CA40.0','CA40','CA40.1','CA20','GC08','1E32','GA0Z','GB07')) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ('CA4Z','CA07.0','CA40.0','CA40','CA40.1','CA20','GC08','1E32','GA0Z','GB07')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,'CA4Z','CA07.0','CA40.0','CA40','CA40.1','CA20','GC08','1E32','GA0Z','GB07');
