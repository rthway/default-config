...
FROM
    ...
    WHERE
    icd11_code IN ("GB60","GB61","GB40","GB40.0","PA9Z","MG26","DA42","PA75","ND56","DB93.1","NE2Z","NE60","PA7Z","1C82","PA78",'PA78.0')) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ("GB60","GB61","GB40","GB40.0","PA9Z","MG26","DA42","PA75","ND56","DB93.1","NE2Z","NE60","PA7Z","1C82","PA78",'PA78.0')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,"GB60","GB61","GB40","GB40.0","PA9Z","MG26","DA42","PA75","ND56","DB93.1","NE2Z","NE60","PA7Z","1C82","PA78",'PA78.0');
