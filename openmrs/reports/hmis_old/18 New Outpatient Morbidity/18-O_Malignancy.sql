...
FROM
    ...
    WHERE
    icd11_code IN ("2C6Z","2C77","2C25","2B70","2B72","2D10","2C12.0","2C10","2E03","2C13","2B91" ,"2B6E" ,"2B33.5" ,"2C73" ,"2C94" ,"2B6B" ,"2C4Z" ,"2D4Z","2B33")) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ("2C6Z","2C77","2C25","2B70","2B72","2D10","2C12.0","2C10","2E03","2C13","2B91" ,"2B6E" ,"2B33.5" ,"2C73" ,"2C94" ,"2B6B" ,"2C4Z" ,"2D4Z","2B33")
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,"2C6Z","2C77","2C25","2B70","2B72","2D10","2C12.0","2C10","2E03","2C13","2B91" ,"2B6E" ,"2B33.5" ,"2C73" ,"2C94" ,"2B6B" ,"2C4Z" ,"2D4Z","2B33");
