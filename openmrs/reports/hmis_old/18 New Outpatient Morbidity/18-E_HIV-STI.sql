...
FROM
    ...
    WHERE
    icd11_code IN ("1C62","1A70.0Y","MF40.2Y","MF3A","MD81.12","KA65.0","GA6Z","GB0Z" ,"BD90.Y" ,"1A6Z" )) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ("1C62","1A70.0Y","MF40.2Y","MF3A","MD81.12","KA65.0","GA6Z","GB0Z" ,"BD90.Y" ,"1A6Z" )
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,"1C62","1A70.0Y","MF40.2Y","MF3A","MD81.12","KA65.0","GA6Z","GB0Z" ,"BD90.Y" ,"1A6Z" );
