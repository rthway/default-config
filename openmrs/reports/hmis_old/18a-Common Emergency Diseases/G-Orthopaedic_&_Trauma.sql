...
FROM
    ...
    WHERE
        icd11_code IN ('NA0Z','NB9Z','NB3Z','ND56','NF0A.6','ND56.8','DA0Y','NA0D.02','NA03.0','MD80')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('NA0Z','NB9Z','NB3Z','ND56','NF0A.6','ND56.8','DA0Y','NA0D.02','NA03.0','MD80')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'NA0Z','NB9Z','NB3Z','ND56','NF0A.6','ND56.8','DA0Y','NA0D.02','NA03.0','MD80')
