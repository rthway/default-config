...
FROM
    ...
    WHERE
        icd11_code IN ('KB8C','CA4Z','CA06.1','CA05.0','CA40','KB06')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('KB8C','CA4Z','CA06.1','CA05.0','CA40','KB06')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'KB8C','CA4Z','CA06.1','CA05.0','CA40','KB06')
