...
FROM
    ...
    WHERE
        icd11_code IN ('NE60.1','PB33','NE60.0','NE61.0','NE61.1','NE61','NE59','NE60')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('NE60.1','PB33','NE60.0','NE61.0','NE61.1','NE61','NE59','NE60')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'NE60.1','PB33','NE60.0','NE61.0','NE61.1','NE61','NE59','NE60')
