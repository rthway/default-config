...
FROM
    ...
    WHERE
        icd11_code IN ('MD81.4','DA42','1A40','DB10','DC12','ME24.9','DB91','DC31','DB50.0','DB30','ME24.3','DC50','MF56','MF50.4','MF50.3','GB01.0','GB05.3')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('MD81.4','DA42','1A40','DB10','DC12','ME24.9','DB91','DC31','DB50.0','DB30','ME24.3','DC50','MF56','MF50.4','MF50.3','GB01.0','GB05.3')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'MD81.4','DA42','1A40','DB10','DC12','ME24.9','DB91','DC31','DB50.0','DB30','ME24.3','DC50','MF56','MF50.4','MF50.3','GB01.0','GB05.3')
