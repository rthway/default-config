...
field(first_answers.answer_name,'Cough/Cold','Pneumonia','Severe Pneumonia','No Dehydration','Some Dehydration','Severe Dehydration','Chronic Diarrhea','Dysentery','ARI','Diarrhoea','Others','Fever','Diarrhea','Malnutrition','Not present','Not applicable');
