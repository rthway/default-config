Select 
SUM(if(counseling = 'True',1,0)) as 'Total Counsel',
SUM(if(result = 'Positive',1,0)) as 'Total Positive',
SUM(if(test = 'True',1,0)) as 'Total Tested',
SUM(if((ART = 'True' and Delivery is null),1,0)) as 'ART Before Delivery',
SUM(if((ART = 'True' and Delivery is not null),1,0)) as 'ART After Delivery'
