...
FROM
    ...
    WHERE
        icd11_code IN ('MD11.5','CA22','CA23.32','CA40','CA71.0','CB21','MD22','BB00.0','NF04','CA81.1','8D60.1','CB41.0','CB00')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('MD11.5','CA22','CA23.32','CA40','CA71.0','CB21','MD22','BB00.0','NF04','CA81.1','8D60.1','CB41.0','CB00')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'MD11.5','CA22','CA23.32','CA40','CA71.0','CB21','MD22','BB00.0','NF04','CA81.1','8D60.1','CB41.0','CB00')
