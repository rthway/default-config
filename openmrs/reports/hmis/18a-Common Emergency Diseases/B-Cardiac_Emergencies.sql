...
FROM
    ...
    WHERE
        icd11_code IN ('MD30','BA4Z','BA41','BC9Z','CB01','BB23','MG40.0','BA03')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('MD30','BA4Z','BA41','BC9Z','CB01','BB23','MG40.0','BA03')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'MD30','BA4Z','BA41','BC9Z','CB01','BB23','MG40.0','BA03')
