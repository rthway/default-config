SELECT 
    ...
    first_answers.answer_name AS 'Obstetric Complications',
...
ORDER BY FIELD(first_answers.answer_name,'Ectopic Pregnancy','Abortion complications','Severe / Pre-Eclampsia','Eclampsia','Hypermesis Gravidraum','Antepartum Haemorrhage','Prolonged labour','Obstructed Labour','PIH','Ruptured Uterus','Postpartum haemorrhage','Retained placenta','Pueperal sepsis','C-Section Wound Infection','Others','RH Negative');
