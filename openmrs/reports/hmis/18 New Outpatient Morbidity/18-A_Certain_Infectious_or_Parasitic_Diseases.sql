...
FROM
    ...
    WHERE
    icd11_code IN ('1F03','1C17','1C12','1C15','1C13','1B1Z','MB56','1F02','1D80','1E90.0','1E51.0Z')) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ('1F03','1C17','1C12','1C15','1C13','1B1Z','MB56','1F02','1D80','1E90.0','1E51.0Z')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,'1F03','1C17','1C12','1C15','1C13','1B1Z','MB56','1F02','1D80','1E90.0','1E51.0Z');
