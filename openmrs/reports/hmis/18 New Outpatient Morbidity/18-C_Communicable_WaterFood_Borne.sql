...
FROM
    ...
    WHERE
    icd11_code IN ('1A07','1A40','1A36.00','1A02','ME05.1','1A00','1F90.2','ME10.1','1E50.0','1E51.3','29','1A0Z')) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ('1A07','1A40','1A36.00','1A02','ME05.1','1A00','1F90.2','ME10.1','1E50.0','1E51.3','29','1A0Z')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,'1A07','1A40','1A36.00','1A02','ME05.1','1A00','1F90.2','ME10.1','1E50.0','1E51.3','29','1A0Z');
