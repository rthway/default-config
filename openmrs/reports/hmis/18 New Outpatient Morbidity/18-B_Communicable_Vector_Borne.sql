...
FROM
    ...
    WHERE
    icd11_code IN ('1D00','1F66','1F45','1F40','1F42','1F42.0','1F41','1F45.0','1D2Z','1F54.0','1C30.3','1C85')) first_answers 
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ('1D00','1F66','1F45','1F40','1F42','1F42.0','1F41','1F45.0','1D2Z','1F54.0','1C30.3','1C85')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code,'1D00','1F66','1F45','1F40','1F42','1F42.0','1F41','1F45.0','1D2Z','1F54.0','1C30.3','1C85');
