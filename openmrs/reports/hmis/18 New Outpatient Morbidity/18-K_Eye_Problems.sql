...
FROM
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND icd11_code IN ('9A60.Z','1C23.Z','9B10','9D90','9D00','9C61','9D44','9A20.00','9A01.20','9A02.01','9A61.1','9B71.0','9B71.1','9A03.1','NA06','9A96','9B78.3','9D46','9C8Y','9B70','MC1Y','2D02.2','MC15','9A01.3','KA65.0')
    WHERE
