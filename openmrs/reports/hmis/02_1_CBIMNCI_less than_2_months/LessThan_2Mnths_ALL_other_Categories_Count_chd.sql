...
ORDER BY field (first_question.answer_name,'PSBI','NBI','LBI','Jaundice status','Difficulty feeding or low weight','Breastfed','Referred out'), field(age_days_grp.age_days,'< 29 days','29 - 59 days');