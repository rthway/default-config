...
FROM
    ...
    WHERE
        icd11_code IN ('5C77','5C76','5C70.1','5C71','5A41','5A22.0','5A74.1')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('5C77','5C76','5C70.1','5C71','5A41','5A22.0','5A74.1')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, '5C77','5C76','5C70.1','5C71','5A41','5A22.0','5A74.1')
