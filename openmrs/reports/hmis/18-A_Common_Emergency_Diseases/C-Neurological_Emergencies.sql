...
FROM
    ...
    WHERE
        icd11_code IN ('MB20.1','8A68','1D0Z','8B20','8C01.0','8D60')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('MB20.1','8A68','1D0Z','8B20','8C01.0','8D60')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'MB20.1','8A68','1D0Z','8B20','8C01.0','8D60')
