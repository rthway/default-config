...
AND cn2.voided = 0
WHERE
DATE(o.obs_datetime) BETWEEN DATE('#startDate#') AND DATE('#endDate#')) UNION ALL 
...
order by FIELD(new_user.method,'Condoms','Emergency Contraception Pills','Pills','Depo','Sayana Press','IUCD','Implant','Minilap','Vasectomy','other')
