...
FROM
    ...
    WHERE
        icd11_code IN ('GA05','GC40','GA20','GA2Y','GB31','GB04')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ('GA05','GC40','GA20','GA2Y','GB31','GB04')
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, 'GA05','GC40','GA20','GA2Y','GB31','GB04')
