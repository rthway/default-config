...
FROM
    ...
    WHERE
        icd11_code IN ("FA20","FA2Z","FA0Z","ME84","ME84.2","MG30.02","ND56.2","FB55","ND56.3","ME84.0","ME85","FA8Z","FA84")) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view_new dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd11_code IN ("FA20","FA2Z","FA0Z","ME84","ME84.2","MG30.02","ND56.2","FB55","ND56.3","ME84.0","ME85","FA8Z","FA84")
    WHERE
...
ORDER BY FIELD(first_answers.icd11_code, "FA20","FA2Z","FA0Z","ME84","ME84.2","MG30.02","ND56.2","FB55","ND56.3","ME84.0","ME85","FA8Z","FA84")
