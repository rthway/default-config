...
FROM
    ...
    LEFT JOIN concept_name answer_concept_short_name ON ca.answer_concept = answer_concept_short_name.concept_id
        ...
        IS FALSE
    WHERE
        question_concept_name.name IN ('ANC, TD Given','Vaccine-BCG','Vaccine-DPT','Vaccine-OPV','Vaccine-PCV','Vaccine-FIPV','Vaccine-Rota','Vaccine-Measles or rubella','Vaccine-JE','Typhoid-Conjugate Vaccine','Vaccine-Hepatitis B','Vaccine-HPV')
            AND cd.name = 'Coded'
    ...
    INNER JOIN concept_name cn1 ON o1.concept_id = cn1.concept_id
        ...
        AND cn1.name IN ('ANC, TD Given','Vaccine-BCG','Vaccine-DPT','Vaccine-OPV','Vaccine-PCV','Vaccine-FIPV','Vaccine-Rota','Vaccine-Measles or rubella','Vaccine-JE','Typhoid-Conjugate Vaccine','Vaccine-Hepatitis B','Vaccine-HPV')
        AND o1.voided = 0
        AND cn1.voided = 0
...
ORDER BY FIELD(first_answers.category,'Vaccine-BCG','Vaccine-Rota','Vaccine-OPV','Vaccine-FIPV','Vaccine-PCV','Vaccine-DPT','Vaccine-Measles or rubella','Vaccine-JE','Typhoid-Conjugate Vaccine','Vaccine-HPV','Vaccine-Hepatitis B','ANC, TD Given' );
