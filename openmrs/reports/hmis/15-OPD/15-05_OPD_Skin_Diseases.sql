...
FROM
    ...
    WHERE
        icd10_code IN ('L70.9','B07','L81.1','L50.9','L30.9','L66','L80','E70.3','A60','B02','L53','L01','L02','L02.9','J34.0','L43.9',
'B86','L81.9','L40.9','L04.9')) first_answers
        LEFT OUTER JOIN
    (SELECT DISTINCT
        (p.person_id),
    ...
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id
     ...
     JOIN diagnosis_concept_view dcv ON dcv.concept_id = o.value_coded
        AND dcv.icd10_code IN ('L70.9','B07','L81.1','L50.9','L30.9','L66','L80','E70.3','A60','B02','L53','L01','L02','L02.9','J34.0','L43.9',
'B86','L81.9','L40.9','L04.9')
    WHERE
...
ORDER BY FIELD(first_answers.icd10_code, 'L70.9','B07','L81.1','L50.9','L30.9','L66','L80','E70.3','A60','B02','L53','L01','L02','L02.9','J34.0','L43.9',
'B86','L81.9','L40.9','L04.9')
